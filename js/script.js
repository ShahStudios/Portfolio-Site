...
function handleTyping() {
  $(".element").typed({
    strings: [
      "Specializing in front-end development and design.",
...
// end: type jquery plugin

// start: wow animate plugin
$(function() {
  new Window().init();
});
// end: wow animate plugin

// add animations
$(window).on("load", function() {
  $("#home-heading-1").addClass("animated fadeInUp");
  $("#home-heading-2").addClass("animated fadeInUp");
  $("#home-heading-3").addClass("animated fadeInUp");
  $("#home-btn").addClass("animated fadeInUp");
  $("#animation-about").addClass("animated fadeInUp");
});
